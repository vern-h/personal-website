...
- Theme toggle with persistent user preference using `localStorage`
- Mobile-friendly navigation with responsive hamburger menu
- Interactive 3D flip card implemented via CSS `transform` and `perspective`
...
This project was designed with a clear visual and structural goal in mind before writing any code. I utilized generative AI tools to assist in accelerating the development process — by crafting precise prompts based on my understanding of HTML5, CSS3, Flexbox, CSS Grid, and responsive design principles.
